                 ...
                 {/*left side content */}
                   ...
                   <div>
                       <div className = 'inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-200 bg-purple-100 text-purple-600 text-sm font-medium'>
                        ...
                        <button onClick={handleGoogleSignIn} className = 'mt-10 h-16 px-8 rounded-2xl bg-gradient-to-r from bg-purple-500 to bg-emerald-500 text-white text-lg font-semibold flex items-center gap-4 shadow-[0_20px_80px_rgba(139,92,246,0.25)] hover:scale-[1.02] transition cursor-pointer' >
